...
def build():
    ...
    shutil.copytree(
        "aks_diagnostics", build_dir / "aks_diagnostics", ignore=shutil.ignore_patterns("__pycache__", "*.pyc", "*.pyo")
    )

    # Create zipapp
    zipapp.create_archive(
        build_dir, target="aks-net-diagnostics.pyz", interpreter="/usr/bin/env python3", compressed=True
    )
