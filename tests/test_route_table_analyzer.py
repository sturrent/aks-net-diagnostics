...
class TestRouteTableAnalyzer(unittest.TestCase):
    ...
    def test_get_unique_subnet_ids(self):
        ...
        agent_pools = [
            ...
            {"vnetSubnetId": "/subscriptions/sub1/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/vnet1/subnets/subnet1"},  # duplicate
    ...
    def test_categorize_route_virtual_appliance(self):
        ...
        route = {
            ...
            "impact": {
                "severity": "high",
                "description": "Routes through firewall",
                "affectedTraffic": ["internet"]
            }
        }
    ...
    def test_categorize_route_internet(self):
        ...
        route = {
            ...
            "impact": {
                "severity": "info",
                "description": "Direct internet route",
                "affectedTraffic": []
            }
        }
