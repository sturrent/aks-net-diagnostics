...
class TestDNSAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.public_cluster_info = {"name": "test-cluster", "apiServerAccessProfile": {"enablePrivateCluster": False}}
        ...
        self.no_api_profile_cluster = {"name": "test-cluster"}
...
"""
        ...
        result = analyzer.validate_private_dns_resolution(
            nslookup_output, "test-api-server.privatelink.canadacentral.azmk8s.io"
        )
