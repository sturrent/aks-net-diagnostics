...
class TestNSGAnalyzer(unittest.TestCase):
    ...
    def test_analyze_subnet_nsgs_with_nsg(self):
        ...
        mock_subnet.network_security_group.id = (
            "/subscriptions/sub-id/resourceGroups/test-rg/providers/Microsoft.Network/networkSecurityGroups/nsg1"
        )
    ...
    def test_analyze_nic_nsgs_with_nsg(self):
        ...
        mock_nsg.id = (
            "/subscriptions/sub-id/resourceGroups/test-rg/providers/Microsoft.Network/networkSecurityGroups/nic-nsg"
        )
    ...
    def test_rules_overlap_destination(self):
        ...
        deny_rule = {"destinationAddressPrefix": "*", "destinationPortRange": "443", "protocol": "TCP"}
    ...
    def test_rules_overlap_port(self):
        ...
        allow_rule_overlap = {"destinationAddressPrefix": "*", "destinationPortRange": "*", "protocol": "TCP"}

        allow_rule_no_overlap = {"destinationAddressPrefix": "*", "destinationPortRange": "80", "protocol": "TCP"}
    ...
    def test_rules_overlap_protocol(self):
        ...
        allow_rule_overlap = {"destinationAddressPrefix": "*", "destinationPortRange": "443", "protocol": "*"}

        allow_rule_no_overlap = {"destinationAddressPrefix": "*", "destinationPortRange": "443", "protocol": "UDP"}
