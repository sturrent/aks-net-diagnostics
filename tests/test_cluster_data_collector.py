...
class TestClusterDataCollector(unittest.TestCase):
    ...
    def test_collect_vnet_info_with_subnets(self):
        ...
        mock_vnet = Mock()
        mock_vnet.id = (
            "/subscriptions/sub-123/resourceGroups/vnet-rg/providers/Microsoft.Network/virtualNetworks/test-vnet"
        )
        ...
        mock_peering.remote_virtual_network.id = (
            "/subscriptions/sub-123/resourceGroups/other-rg/providers/Microsoft.Network/virtualNetworks/other-vnet"
        )
        ...
        self.mock_sdk_client.network_client.virtual_network_peerings.list.assert_called_once_with(
            "vnet-rg", "test-vnet"
        )
    ...
    def test_collect_vmss_info_success(self):
        ...
        self.mock_sdk_client.compute_client.virtual_machine_scale_sets.get.side_effect = [
            mock_vmss_detail_1,
            mock_vmss_detail_2,
        ]
        ...
        # Verify SDK methods were called correctly
        self.mock_sdk_client.compute_client.virtual_machine_scale_sets.list.assert_called_once_with(
            "MC_test-rg_test-cluster_eastus"
        )
    ...
    def test_collect_all_success(self):
        ...
        # Mock cluster object
        mock_cluster = Mock()
        mock_cluster.as_dict.return_value = {"name": "test-cluster", "nodeResourceGroup": "MC_test-rg"}
        mock_cluster.status = None  # No status object
