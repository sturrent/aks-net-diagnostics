...
class TestAPIServerAccessAnalyzer(unittest.TestCase):
    ...
    def test_private_cluster(self):
        ...
        self.assertIn('API server is isolated from the internet', 
                     ' '.join(result['accessRestrictions']['implications']))
    ...
    def test_unrestricted_public_cluster(self):
        ...
        security_findings = [f for f in result['securityFindings'] 
                           if f['issue'] == 'Unrestricted public access']
    ...
    def test_restricted_public_cluster(self):
        ...
        warning_findings = [f for f in result['securityFindings'] 
    ...
    def test_wildcard_ip_range_critical(self):
        ...
        critical_findings = [f for f in result['securityFindings'] 
    ...
    def test_very_broad_ip_range_high_severity(self):
        ...
        high_findings = [f for f in result['securityFindings'] 
                        if f['severity'] == 'high']
    ...
    def test_broad_ip_range_medium_severity(self):
        ...
        cluster_info = {
            **self.base_cluster_info,
            'apiServerAccessProfile': {
                'enablePrivateCluster': False,
                'authorizedIpRanges': ['172.16.0.0/16']
            }
        }
        ...
        medium_findings = [f for f in result['securityFindings'] 
                          if f['severity'] == 'medium' and 'range' in f]
    ...
    def test_private_cluster_with_authorized_ranges(self):
        ...
        info_findings = [f for f in result['securityFindings'] 
                        if f['severity'] == 'info']
    ...
    def test_outbound_ip_in_authorized_ranges(self):
        ...
        authorized_message = [imp for imp in implications 
                            if 'All outbound IPs' in imp and '[OK]' in imp]
    ...
    def test_outbound_ip_not_in_authorized_ranges(self):
        ...
        unauthorized_message = [imp for imp in implications 
                               if 'not explicitly in authorized ranges' in imp]
    ...
    def test_specific_single_ip_authorized(self):
        ...
        cluster_info = {
            **self.base_cluster_info,
            'apiServerAccessProfile': {
                'enablePrivateCluster': False,
                'authorizedIpRanges': ['203.0.113.50/32']
            }
        }
        ...
        range_findings = [f for f in result['securityFindings'] 
                         if 'range' in f and f['range'] == '203.0.113.50/32']
    ...
    def test_outbound_ip_range_in_list(self):
        ...
        range_message = [imp for imp in implications 
                        if 'Outbound IP range detected' in imp]
    ...
    def test_udr_override_with_authorized_ranges(self):
        ...
        cluster_info = {
            **self.base_cluster_info,
            'apiServerAccessProfile': {
                'enablePrivateCluster': False,
                'authorizedIpRanges': ['45.65.190.26/32']
            }
        }
