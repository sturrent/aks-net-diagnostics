...
EXAMPLES:
  ...
  %(prog)s -n my-cluster -g my-rg --details --json-report
        ...
        # Initialize Azure SDK client
        self.azure_sdk_client = AzureSDKClient(subscription_id=None)
    ...
    def analyze_nsg_configuration(self):
        ...
        try:
            ...
            nsg_analyzer = NSGAnalyzer(
                azure_sdk_client=self.azure_sdk_client, cluster_info=self.cluster_info, vmss_info=self.vmss_analysis
            )
    ...
    def analyze_private_dns(self):
        ...
        try:
            ...
            dns_analyzer = DNSAnalyzer(cluster_info=self.cluster_info, azure_sdk_client=self.azure_sdk_client)
    ...
    def check_api_connectivity(self):
        ...
        tester = ConnectivityTester(
            self.cluster_info, self.azure_sdk_client, self.dns_analyzer, show_details=self.show_details
        )
