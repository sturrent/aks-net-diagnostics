    ...
    def _analyze_vnet_dns_servers(self) -> None:
        ...
        try:
            ...
            if non_azure_dns and is_private_cluster:
                ...
                self.logger.warning("  [ERROR] Custom DNS servers may prevent private DNS resolution")
                ...
                self.logger.warning("  [WARNING] Custom DNS may impact CoreDNS and Azure service resolution")
