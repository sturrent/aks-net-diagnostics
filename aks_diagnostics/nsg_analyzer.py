            ...
            for nic in network_interfaces:
                ...
                for ip_config in ip_configs:
                    ...
                    try:
                        ...
                        subnet_info = self.sdk_client.network_client.subnets.get(subnet_rg, vnet_name, subnet_name)
                        ...
                        if nsg_info:
                            ...
                            nsg_details = self.sdk_client.network_client.network_security_groups.get(nsg_rg, nsg_name)
