...
class FindingCode(Enum):
    ...
    PERMISSION_INSUFFICIENT_NSG = "PERMISSION_INSUFFICIENT_NSG"
    PERMISSION_INSUFFICIENT_DNS = "PERMISSION_INSUFFICIENT_DNS"
    PERMISSION_INSUFFICIENT_PROBE_TEST = "PERMISSION_INSUFFICIENT_PROBE_TEST"
